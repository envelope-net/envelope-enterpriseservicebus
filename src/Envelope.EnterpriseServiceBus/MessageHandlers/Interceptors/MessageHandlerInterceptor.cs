...
public abstract class MessageHandlerInterceptor<TRequestMessage, TResponse, TContext> : IMessageHandlerInterceptor<TRequestMessage, TResponse, TContext>, IMessageHandlerInterceptor
