...
namespace Envelope.EnterpriseServiceBus.Messages.Internal;

internal class JobMessage : IJobMessage
{
	...
	public void Archive(
		...
		bool? isDetailJson = null)
	{
		var clon = JobMessageFactory.CreateArchivedMessage(this, traceInfo, properties, detail, isDetailJson);
		if (clon != null)
			CopyFrom(clon);
	}

	public bool CanComplete()
		=> JobMessageFactory.CanComplete(this);

	public bool CanSuspend()
		=> JobMessageFactory.CanSuspend(this);

	public bool CanResume()
		=> JobMessageFactory.CanResume(this);

	public bool CanDelete()
		=> JobMessageFactory.CanDelete(this);
