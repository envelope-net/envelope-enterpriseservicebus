...
namespace Envelope.EnterpriseServiceBus.Jobs.Logging;
...
public class DefaultJobLogger : IJobLogger
{
		...
		CancellationToken cancellationToken = default)
	{
		...
		messageBuilder = AppendToBuilder(messageBuilder, logCode, job, executeResult, newExecuteStatus, detail, jobMessageId);
