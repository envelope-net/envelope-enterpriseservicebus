...
namespace Envelope.EnterpriseServiceBus.Orchestrations.Logging;
...
public class DefaultOrchestrationLogger : IOrchestrationLogger
{
	...
	{
		messageBuilder = AppendToBuilder(messageBuilder, idOrchestration, idStep, idExecutionPointer, detail);
